...
namespace CCC.Fix2D.Debugging
{
    ...
    public class PhysicsDebugStreamSystem : SystemBase
    {
        ...
        public struct Context
        {
            ...
            {
                SafetyChecks.IsTrue(vertexCount <= Collider.PolygonConstants.MaxVertexCount);
        ...
        {
            public unsafe fixed byte Vertices[(sizeof(float) * 2) * Collider.PolygonConstants.MaxVertexCount];
...
#if UNITY_EDITOR    
                UnityEditor.Handles.Label(new float3(Position, 0f), new string(stringBuf), style);
#endif // UNITY_EDITOR                
            }
        }
        ...
        private class PhysicsDrawComponent : MonoBehaviour
        {
            ...
            public static void UpdateInstance()
            {
                ...
                // destroy old
                if (s_instance != null && s_instance.GetComponent<Camera>() != mainCamera)
                {
                    Destroy(s_instance);
                    s_instance = null;
                }
                ...
                // create new
                if (s_instance == null && mainCamera != null)
                {
                    s_instance = mainCamera.gameObject.AddComponent<PhysicsDrawComponent>();
                }
            }
...
#endif
            {
                ...
                {
                    var debugStreamSystem = world.GetExistingSystem<PhysicsDebugStreamSystem>();
                    if (debugStreamSystem != null)
                    {
                        // Make sure all potential debug display jobs are finished
                        debugStreamSystem.m_EndFramePhysicsSystem.FinalJobHandle.Complete();

                        // Draw everything.
                        debugStreamSystem.Draw();
                    }
                }
            }
        }
        ...
        protected override void OnUpdate()
        {
            ...
            PhysicsDrawComponent.UpdateInstance();
        }
