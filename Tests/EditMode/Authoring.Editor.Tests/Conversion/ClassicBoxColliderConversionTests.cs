...
[TestFixture]
class ClassicBoxColliderConversionTests : BaseClassicColliderConversionFixture
{
    [Test]
    public void BoxCollider_BadTransformScale_ConversionTest()
    {
        // Set-up the hierarchy.
        {
            ...
            CreateClassicComponent<BoxCollider2D>(Root);
        }
    ...
    public void BoxCollider_Root_ConversionTest()
    {
        ...
        // Set-up the hierarchy.
        {
            ...
            var collider = CreateClassicComponent<BoxCollider2D>(Root);
